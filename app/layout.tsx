...
const HOMEPAGE_DESCRIPTION =
  "Pregătire online pentru BAC informatică Moldova prin 3 certificări Certiport (Python, SQL, Devices) — certificări internațional recunoscute, utile pentru pregătirea probei de informatică. De la 240 MDL/lună. Făcut în Chișinău de elevi care au luat 10.";

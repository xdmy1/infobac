...
export function buildCourse(step: PathwayStep) {
  return {
    ...
    name: `Pregătire pentru ${step.certName}`,
    ...
    educationalCredentialAwarded: {
      ...
      name: `Pregătire pentru certificarea ${step.certName}`,
      credentialCategory: "certificate preparation",
      recognizedBy: { "@type": "Organization", name: "Certiport (a Pearson VUE Business)" },
    },
    inLanguage: "ro-MD",
    isAccessibleForFree: false,
    teaches: step.title,
    about: step.title,
    courseCode: `IB-${step.slug}`,
...
export function buildHowTo() {
  return {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "Cum te pregătești pentru proba de informatică din BAC prin certificările Certiport IT Specialist",
    description:
      "Pașii pentru pregătirea probei de informatică din BAC prin certificările Certiport IT Specialist.",
    totalTime: "P8W",
    inLanguage: "ro-MD",
    image: `${siteConfig.url}${siteConfig.ogImage}`,
    estimatedCost: {
